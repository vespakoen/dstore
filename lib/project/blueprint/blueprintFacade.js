...
BlueprintFacade.prototype.forEveryBlueprintVersion = function(projectId, blueprintId, cb) {
  return this.service.forEveryBlueprintVersion(projectId, blueprintId, cb);
};
...
BlueprintFacade.prototype.putManyBlueprints = function(projectId, blueprints) {
  var self = this;
  var chain = BBPromise.resolve();
  var results = {};
  _.each(blueprints, function (blueprint, blueprintId) {
