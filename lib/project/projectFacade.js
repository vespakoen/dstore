...
ProjectFacade.prototype.getProjectVersion = function(projectId) {
  return BBPromise.join(
    this.service.getProjectVersion(projectId),
    this.blueprintFacade.getAllBlueprintVersions(projectId)
  )
  .spread(function (projectVersion, blueprintVersions) {
    return {
...
ProjectFacade.prototype.putProject = function(projectId, blueprints) {
  var self = this;
  return this.blueprintFacade.putManyBlueprints(projectId, blueprints)
