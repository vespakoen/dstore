...
SchemaSnapshotter.prototype.createSnapshot = function(namespace) {
  ...
  return this.service.getLatestSnapshotVersion()
...
SchemaSnapshotter.prototype._getSnapshots = function(opts) {
  return BBPromise.join(
    this.service.getSnapshot(opts.snapshotVersion),
    this.service.getSnapshot('current')
  );
};
...
SchemaSnapshotter.prototype._storeSnapshot = function(opts) {
  return this.service.putSnapshot(opts.newVersion, opts.currentSnapshot);
};
