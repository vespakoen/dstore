...
SchemaService.prototype.putSchema = function(namespace, schemaKey, schema) {
  ...
  return this._validatePutSchema(namespace, schemaKey, schema)
    ...
    .then(function() {
      return opts.client.getSchema('current', schemaKey);
    });
};
...
SchemaService.prototype.putSnapshot = function(namespace, snapshotVersion, snapshot) {
  var client = this.adapter.getClient(namespace);
  return client.putSnapshot(snapshotVersion, snapshot);
};

SchemaService.prototype.getLatestSnapshotVersion = function(namespace) {
  var client = this.adapter.getClient(namespace);
