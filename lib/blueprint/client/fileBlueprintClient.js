...
function FileBlueprintClient(differ, path, projectId) {
  BlueprintClient.call(this, differ);
  this.path = path;
  this.blueprintPath = path + '/' + projectId;
}
  ...
  return app.get('blueprint.differ')
    .then(function (differ) {
      return function (projectId) {
        return new FileBlueprintClient(differ, path, projectId);
      };
    });
};
...
FileBlueprintClient.prototype.getBlueprint = function(snapshotVersion, blueprintId) {
...
FileBlueprintClient.prototype.putBlueprint = function(snapshotVersion, blueprintId, blueprint) {
  var self = this;
