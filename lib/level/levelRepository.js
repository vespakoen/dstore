...
LevelRepository.prototype.putItem = function (projectId, blueprintId, id, item) {
  ...
  return this._validatePutItem(projectId, blueprintId, id, item)
    ...
    .then(function(item) {
      ...
      var client = self.adapter.getClient(projectId, item.snapshot_version);
 ...
 * @return {BBPromise}
 */
LevelRepository.prototype.getIdToTypeMap = function(projectId, snapshotVersion, ids) {
  var self = this;
  ...
  return new BBPromise(function(resolve) {
    ...
    var client = self.adapter.getClient(projectId, snapshotVersion);
    var typeByIdDb = client.sublevel('type-by-id');
 ...
 * @return {Stream}
 */
LevelRepository.prototype.getStream = function (projectId, snapshotVersion) {
  var self = this;
