 ...
 */
PostgresqlMigrator.prototype.migrate = function(namespace, snapshotVersion, blueprints) {
  var self = this;
  var opts = {
    namespace: namespace,
...
PostgresqlMigrator.prototype._createDatabase = function(opts) {
  return opts.managementClient.queryAsync('CREATE DATABASE ' + opts.namespace + 'v' + opts.snapshotVersion + ' TEMPLATE=template_postgis')
    .catch(function (err) {
