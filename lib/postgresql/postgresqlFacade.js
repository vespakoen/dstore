 ...
 * @return {BBPromise}
 */
PostgresqlFacade.prototype.putItem = function(namespace, blueprintKey, id, item) {
 ...
 * @return {BBPromise}
 */
PostgresqlFacade.prototype.delItem = function(namespace, blueprintKey, id) {
 ...
 */
PostgresqlFacade.prototype.migrate = function(namespace, snapshotVersion, blueprints) {
 ...
 */
PostgresqlFacade.prototype.serialize = function(namespace, blueprintKey, item) {
