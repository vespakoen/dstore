 ...
 * @return {BBPromise}
 */
PostgresqlFacade.prototype.delItem = function(namespace, schemaKey, snapshotVersion, id) {
  return this.repository.delItem(namespace, schemaKey, snapshotVersion, id);
};
