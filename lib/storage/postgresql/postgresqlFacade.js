 ...
 * @return {BBPromise}
 */
PostgresqlFacade.prototype.getItem = function (projectId, blueprintId, projectVersion, id) {
 ...
 * @return {BBPromise}
 */
PostgresqlFacade.prototype.putItemForSingleVersion = function(projectId, blueprintId, id, item) {
