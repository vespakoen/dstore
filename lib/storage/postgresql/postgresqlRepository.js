 ...
 * @return {BBPromise}
 */
PostgresqlRepository.prototype.getItem = function (projectId, blueprintId, projectVersion, id) {
  var opts = {};

  var client = this.adapter.getClient(projectId, projectVersion);
  return this.blueprintFacade.getBlueprint(projectId, blueprintId, projectVersion)
    .then(function (blueprint) {
      
      var selects = ['*'];
      _.each(blueprint.columns, function (column, key) {
 ...
 * @return {BBPromise}
 */
PostgresqlRepository.prototype.putItemForSingleVersion = function (projectId, blueprintId, id, item) {
  var self = this;
  var opts = {
    id: id,
    item: item
