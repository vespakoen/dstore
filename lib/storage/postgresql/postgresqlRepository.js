 ...
 */
function PostgresqlRepository(adapter, serializer, blueprintService, itemTransformer, validator) {
...
PostgresqlRepository.attach = function(app) {
  return BBPromise.join(
    ...
    app.get('validator')
  ).spread(function (adapter, serializer, blueprintService, itemTransformer, validator) {
    return new PostgresqlRepository(adapter, serializer, blueprintService, itemTransformer, validator);
  });
};
 ...
 * @return {BBPromise}
 */
PostgresqlRepository.prototype.delItem = function (projectId, blueprintId, id) {
  ...
  //   .then(function () {
  //     return self.blueprintService.getAllBlueprints(projectVersion);
  //   })
  //   .then(function (snapshot) {
  //     var blueprint = snapshot[blueprintId];
